...
export class AttachmentUpload implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	private getImageResourceSuccess(fileType: string,
		fileContent: string): void {
		let imageBase64: string = "data:image/" + fileType + ";base64, " + fileContent;
		this.uploadProps.uploadIcon = imageBase64;
	}

	private getImageResourceError(): void {
